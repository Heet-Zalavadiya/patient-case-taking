"""
Manual end-to-end self-test script for MediKiosk AI module (Day 3 Integration).
...
3. Verifies turn-by-turn logging and backend client resilience.
...
7. Verifies backend client calls succeed or catch connection warnings safely.
"""
